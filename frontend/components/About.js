...
export default function(){
    return <motion.div className="font-display max-w-screen-sm mx-5 sm:mx-auto mt-4" initial={{y: -25, opacity: 0}}
        ...
        <Link href="\">
            <a className="text-center bg-pink-600 block md:inline-block rounded-lg py-3 
                        font-display transition-all duration-200 font-medium hover:bg-pink-400 focus:bg-pink-400 px-12 mt-8 text-white" >&larr; Go Back</a>
        </Link>
        </motion.div>
}
