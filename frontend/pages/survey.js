                    ...
                    <div className={`h-full flex ${displayMode === "question" ? "items-center" : "items-start"} px-4`}>
                        {displayMode === "question" ? <div className="w-full mx-auto max-w-7xl text-center">
                            ...
                            <div className="lg:space-x-4 space-y-4 lg:space-y-0 mt-6">
                                ...
                                hover:bg-pink-50 hover:text-pink-400 hover:border-pink-200
                                focus:bg-pink-50 focus:text-pink-400 focus:border-pink-200
                                "
                            ...
                            <ul className="divide-y divide-gray-200 w-full">
                                {sorted.map(item => <li className="flex group justify-start items-center" key={item.name}>
                                        ...
                                        <a className="block py-4 w-full text-left" href={item.url} target="_blank">
                                            <h2 className="lg:text-xl font-semibold text-gray-800 group-hover:text-pink-400 group-focus:text-pink-400 transition-all duration-150 inline-flex items-center">
                                                {item.name}
                                            </h2>
                                            <p className="text-sm lg:text-lg text-gray-600 group-hover:text-pink-400 transition-all duration-200">
                                                {item.description}
                                            </p>
                                        </a>
                                    </li>
