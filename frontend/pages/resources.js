...
const Resources = () => {
    ...
    const linkPillStyle = `py-1 hover:bg-pink-50 hover:border-pink-300 hover:text-pink-400
    focus:bg-pink-50 focus:border-pink-300 focus:text-pink-400
                        ...
                        {resourceTree.resources.map(resource => (
                            <li key={resource.id} className="py-3">
                                <a className="group" href={resource.url} target="_blank">
                                    <h2 className="text-base font-medium text-gray-800 group-hover:text-pink-400 group-focus:text-pink-400">
                                        {resource.name}
                                    </h2>
                                    <p className="text-gray-500 group-hover:text-pink-400 group-focus:text-pink-400 text-sm">
