...
const Suggest = () => {
    ...
    const inputStyle = "p-4 text-lg md:text-xl border rounded-lg shadow-sm focus:outline-none w-full polyfill-button"
        ...
        <div className="max-w-3xl mx-auto px-4 my-24">
            ...
            <form className="w-full pt-4 space-y-4" onSubmit={submitSuggestion}>
                ...
                <button type="submit" disabled={isLoading || !capcha}
                        className="px-6 float-right py-3 text-white bg-pink-00 font-semibold rounded-lg hover:bg-red-500 focus:bg-red-500 transition-all duration-200">
